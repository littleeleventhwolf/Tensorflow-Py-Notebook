...
def spatial_transformer_network(input_fmap, theta, out_dims=None, **kwargs):
	...
	- theta: affine transform tensor of shape (B, 6). Permits cropping,
	  ...
	  It is the output of the localisation network.
...
def affine_grid_generator(height, width, theta):
	...
	Input
	-----
	- height: desired height of grid/output. Used to
	  downsample or upsample.

	- width: desired width of grid/output. Used to
	  downsample or upsample.

	- theta: affine transform matrices of shape
	  (num_batch, 2, 3). For each image in the batch,
	  we have 6 theta parameters of the form (2x3) that
	  define the affine transformation T.
