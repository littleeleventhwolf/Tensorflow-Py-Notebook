...
def transformer(U, theta, out_size, name='SpatialTransformer', **kwargs):
	...
	----------
	U : float
	    The output for a convolutional net should have the
	...
	def _transform(theta, input_dim, out_size):
		with tf.variable_scope('_transform'):
			...
			input_transformed = _interpolate(input_dim, x_s_flat,
				                             y_s_flat, out_size)
...
def batch_transform(U, thetas, out_size, name='BatchSpatialTransformer'):
	"""
